  ...
  return (
    <div className="">
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col text-left rounded-lg px-2 pb-1 border shadow-xl ">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex justify-center w-1/3 items-center">
              <button className="w-16 h-7 font-serif font-semibold text-white hover:scale-105 text-center bg-[#176847] text-md rounded-md cursor-pointer">
                Send
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col text-left gap-5 rounded-lg px-2 pb-1 border shadow-xl">
