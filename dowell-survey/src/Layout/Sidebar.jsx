        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <div className="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1">
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/newSurvey' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to="/newSurvey"
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/finalize-Sample' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to="/finalize-Sample"
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/link-form' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to="/link-form"
                  className="py-1"
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/email-sms' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to="/email-sms"
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/stop' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to=""
              ...
              <li className={`font-bold my-2 text-center text-lg h-8 ${location.pathname === '/repeat' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                <Link
                  to=""
          ...
          <div>
            ...
            >
              <ul className="items-center justify-center space-y-2 md:flex md:space-x-6 md:space-y-0">
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/finalize-Sample' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to="/finalize-Sample"
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/link-form' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to="/link-form"
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/email-sms' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to="/email-sms"
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/start' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to=""
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/stop' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to=""
                ...
                <li className={`font-bold text-lg h-8 ${location.pathname === '/repeat' ? 'text-[#399544] bg-white rounded-md px-1' : 'text-white hover:text-gray-600'}`}>
                  <Link
                    to=""
