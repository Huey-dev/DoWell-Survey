    ...
    <Layout>
      <div className="min-h-screen flex justify-end">
        <div className="flex flex-col items-center justify-center gap-8 w-full px-4 sm:px-0 md:w-[80%] ">
          ...
          <button
            type="button"
            className="w-full sm:w-[40%] font-serif p-2 font-bold text-center bg-[#005734] opacity-80 hover:opacity-100 text-[16px] md:text-[20px] rounded-[12px] text-white cursor-pointer"
          >
