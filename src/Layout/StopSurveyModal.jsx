...
const StopSurveyModal = () => {
  ...
  return (
    <div className="">
      <button
        className="bg-gray-400 text-center text-xs align-middle    px-10  justify-center font-serif font-bold block text-white hover:text-black ml-2 flex-1"
        type="button"
