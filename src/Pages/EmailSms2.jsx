...
const EmailModal = ({
  ...
  const handleGetEmails = async (website) => {
    ...
    const percent = 100 / web_tests.length;
    ...
    const formDatas = web_tests.map((website) => ({
      "web_url": `${website}`,
      "info_request": {
        "emails": true
      }
    ...
    try {
      ...
      setSelectedEmails((selectedEmails) => [...namesEmails, ...selectedEmails]);
                    ...
                    <div className="flex justify-between">
                      <div className="w-5/12 flex flex-col justify-between py-4">
                        <div className="h-72 flex flex-col justify-between">
                          ...
                          <div className="h-64 border border-[#005734] my-1 overflow-y-auto">
                            {
                              websites.map((website, index) => (
                                <div key={index} className='flex w-full text-sm bg-white mt-1 rounded-lg'>
