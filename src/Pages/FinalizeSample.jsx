                            ...
                            {surveys.length >= 1 ? (
                              ...
                              <>
                                ...
                                <tr
                                  ...
                                  className="border-black border-b"
                                >
                                  <td className="whitespace-nowrap  px-6 py-4 font-medium">cx</td>
                                  <td className="whitespace-nowrap  px-6 py-4">dddddddddddddddddd</td>
                                  <td className="px-6 py-4 font-semibold text-md">
                                    You did not add any location.
                                  </td>

                                  <td className="whitespace-nowrap  px-6 py-4">fffff</td>

                                  <td className="whitespace-nowrap  px-6 py-4">dsdsdsdsdsd</td>
                                </tr>
