...
//     const [pageloadModal, setPageLoadModal] = useState(true);
...
//                     Select Distance(m) from Location's Center
//                   </h2>
...
//                     <button
//                       type="button"
//                       className={`mb-2 w-[150px] h-[30px] font-serif font-bold ${
//                         surveys.length < 1
//                           ? "opacity-60 cursor-not-allowed"
//                           : "opacity-80 hover:opacity-100"
//                       } text-center text-sm md:text-md text-white bg-[#005734]`}
...
//       </Layout>
//     ) : (
//       <div className="flex justify-center mt-60 items-center bg-white ">
...
const LandingPage = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setNearbyResults(response.data.place_id_list);
      console.log(
        "coordinates used for the search are",
        centerCoords.lat,
        centerCoords.lon
      );
      console.log("nearby", nearbyResults);
