      ...
      <main className="w-full h-full mb-10 mt-20 overflow-x-hidden ">
        ...
        <div className="px-4 md:px-10 mt-[40px] md:pl-[310px]">
          ...
          <div className="w-full h-full bg-[#D3FFE6] mt-6 pb-6">
            <p className="text-[18px] font-bold pt-[10px] pl-5">
              60 search results
            </p>
                ...
                {products1.map((product) => {
                  ...
                  return (
                    <div
                      key={id}
                      className={
                        "mx-auto w-[270px] md:w-[180px] lg:w-[200px] xl:w-[280px] 2xl:w-[300px] mt-[30px] h-[320px] rounded-[10px] border-2 border-black" +
                        (surveys.findIndex((obj) => obj.id === id) === -1
                          ? " bg-white text-black"
