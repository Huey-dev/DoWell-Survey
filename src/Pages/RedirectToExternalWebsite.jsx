...
const RedirectToExternalWebsite = () => {
  useEffect(() => {
    ...
    window.location.href = 'https://100014.pythonanywhere.com/?redirect_url=http://localhost:5173/DoWell-Survey/'; // or use window.location.replace for a similar effect
  }, []);
