...
const RedirectToExternalWebsite = () => {
  useEffect(() => {
    ...
    window.location.href = 'https://100014.pythonanywhere.com/?redirect_url=https://dowelllabs.github.io/DoWell-Survey/'; // or use window.location.replace for a similar effect
  }, []);
